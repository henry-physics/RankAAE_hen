...
class AuxSpectraDataset(Dataset):
    def __init__(self, csv_fn, split_portion, train_val_test_ratios=(0.85, 0.15, 0.0),
...
def get_dataloaders(csv_fn, batch_size, train_val_test_ratios=(0.85, 0.15, 0.0), n_aux=0,
